...
<head>
	...
	================================================== -->
	<meta charset="utf-8">
	<title>Golden Trade Center | Export & Import Businesses</title>
	<meta name="description"
	      content="Golden Trade Centre is considered as one of the leading exporter of tobacco products in Bangladesh. Since 2007, Golden Trade Centre has been operating export and import business in Middle East. The company also has operations in the Asian countries as well.">
	<meta name="author" content="Mohd. Shah Alam">
	<meta name="keywords"
	      content="export, import, chittagong, bangladesh, jute, betel leaf, tobacco, handicraft, hotel, resorts, suppliers">
					...
					<div class="container clearfix">
						<div class="grid_12">
							...
							<ul class="header-top-menu unstyled">
								<li><a href="#">goldentradecentre@yahoo.com</a></li>
								<li><a href="#">+880 01818529291</a></li>
								<li><a href="http://www.goldentradecenter.com/webmail">Web Mail</a></li>
